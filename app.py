...
@app.route('/')
def home_page():
    return "<h1 >Hello everyone </h1><h3 style='color:blue;'>My Name is Sathish Vanga</h3>  <h3 style='color:blue;'>Data Scicene Intern at Innomatics Research Labs</h3>"

@app.route('/profile')
def about_page():
    return "<h3 style='background-color:red;'>Connect with me on Linkedin</h3><a href='https://www.linkedin.com/in/sathish-vanga' target='_blank'>Linkedin</a>"
